...
test_that("Test errors", {
  ...
  expect_error(get_combustion_equation("H2"), "only contain")
  expect_error(get_combustion_equation("C2"), "only contain")
  expect_error(get_combustion_equation("LiCH2"), "only contain")
